...
$page->addContent("<form method=\"post\" action=\"".$_SERVER['PHP_SELF']. "?signupid=$signupId\">");
...
$page->addContent("<input type=\"submit\" value=\"OK\" /></form>");
	...
	if($signupGadget->isOpen()){	
		...
		$page->addContent("<p class=\"csv-output\"><a href=\"csv_output.php?signupid=$signupId\">Vastaukset csv-muodossa</a></p>");
